...
const Navbar = () => {
  return (
    <nav className="fixed top-0 w-full flex items-center justify-center z-50 bg-transparent px-6 py-8">
      <Menubar className="min-w-1/4 bg-white/70 backdrop-blur-md rounded-3xl shadow-md px-6 py-8 flex justify-between">
        {/* Home */}
        <MenubarMenu>
          <MenubarTrigger>
        ...
        {/* Services */}
        <MenubarMenu>
          <MenubarTrigger className="px-2 cursor-pointer">Services</MenubarTrigger>
          <MenubarContent>
            <MenubarItem>
        ...
        <MenubarMenu>
          <MenubarTrigger className="px-2 cursor-pointer">Account</MenubarTrigger>
          <MenubarContent>
            <MenubarItem>
